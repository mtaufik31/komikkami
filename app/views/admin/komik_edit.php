        ...
        <main class="flex-grow-1">
            ...
            <div class="container-fluid px-4 mx-2">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h3 class="fw-bold mb-1">Edit Data Komik</h3>
                        <p class="text-secondary mb-0">Ubah detail informasi komik yang tersimpan di sistem.</p>
                    </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-4">
                        ...
                        <form action="?aksi=admin_komik_update" method="POST" enctype="multipart/form-data">

                            <input type="hidden" name="id_komik" value="<?= $komik['id_komik']; ?>">

                            <div class="mb-4">
                                <label class="form-label fw-semibold">Judul Komik</label>
                                <input type="text"
                                    name="judul"
                                    class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="<?= $komik['genre']; ?>"
                                    required>
                                <div class="form-text text-danger">Pisahkan genre menggunakan tanda koma (,)</div>
                            </div>
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-semibold">Cover Komik</label>

                                <div class="mb-2">
                                    <small class="text-muted d-block mb-1">Cover saat ini:</small>
                                    <img src="img/<?= $komik['gambar']; ?>" alt="Cover Lama" class="img-thumbnail" style="max-height: 120px;">
                                </div>
                                ...
                                <input type="file"
                                    ...
                                    class="form-control"
                                    accept="image/*">
                                <div class="form-text">Biarkan kosong jika tidak ingin mengubah cover gambar.</div>
                            </div>

                            <hr>

                            <div class="d-flex justify-content-end gap-2">
                                <a href="?aksi=admin_komik" class="btn btn-outline-secondary">Batal</a>
                                <button type="submit" class="btn btn-danger">
                                    <i class="bi bi-floppy me-1"></i> Perbarui Komik
                                </button>
                            </div>
